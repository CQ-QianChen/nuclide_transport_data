...
def generate_samples(
    ...
    rock_type = input_df_group["rock_type"].iloc[0]
    nuclide_rock_property = input_df_group["nuclide_property"].iloc[0]
    for (
        sample_size,
        sampled_data,
        value,
...
def generate_unit(property_name):
    ...
    """
    if property_name == "sorption_coefficient":
        unit_str = "m^3/kg"
...
def merge_property_value(input_property, sample_size=1000000, source_type="merged", sampling_functions_by_property=None):
    ...
    input_prop_scalar = input_property.loc[input_property["type"] == "scalar"]
    ...
    # Group the input property by 'nuclide'
    input_nuclide_grouped = input_prop_scalar.groupby(["nuclide"])
    ...
    for nuclide_group_keys, input_nuclide_group in input_nuclide_grouped:
        ...
        if (input_nuclide_group.shape[0] == 1) and (not is_pdf_df.empty):
            ...
            merged_property = pd.concat(
                [
                    property_df
                    for property_df in [merged_property, input_nuclide_group]
            ...
            (
                ...
                samples_min,
                samples_max,
            ) = get_sample_statistics(input_nuclide_group)
            ...
            if samples_std == 0.0:
                ...
                if (sampling_functions_by_property) and (nuclide_name in sampling_functions_by_property):
                    ...
                    # use log normal distribution as default sampling function
            ...
            property_dict = {
                ...
                "unit_str": generate_unit(nuclide_rock_property)[0],
                "unit_base": generate_unit(nuclide_rock_property)[1],
                "variable_name": None,
